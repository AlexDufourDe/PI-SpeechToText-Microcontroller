...
static const ai_network_entry_t networks[AI_MNETWORK_NUMBER] = {
    {
        .name = (const char *)AI_NETWORK_1669802707750_MODEL_NAME,
        .config = AI_NETWORK_1669802707750_DATA_CONFIG,
        .ai_get_report = ai_network_1669802707750_get_report,
        .ai_create = ai_network_1669802707750_create,
        .ai_destroy = ai_network_1669802707750_destroy,
        .ai_get_error = ai_network_1669802707750_get_error,
        .ai_init = ai_network_1669802707750_init,
        .ai_run = ai_network_1669802707750_run,
        .ai_forward = ai_network_1669802707750_forward,
        .ai_data_params_get = ai_network_1669802707750_data_params_get,
        .activations = data_activations0
    },
    {
        .name = (const char *)AI_ASC_MODEL_NAME,
        .config = AI_ASC_DATA_CONFIG,
        .ai_get_report = ai_asc_get_report,
        ...
        .ai_data_params_get = ai_asc_data_params_get,
