/**
  ******************************************************************************
  * @file    network_1669802707750.h
  * @author  AST Embedded Analytics Research Platform
  * @date    Wed Nov 30 11:37:04 2022
...
#ifndef AI_NETWORK_1669802707750_H
#define AI_NETWORK_1669802707750_H
#pragma once

#include "network_1669802707750_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_NETWORK_1669802707750_MODEL_NAME          "network_1669802707750"
#define AI_NETWORK_1669802707750_ORIGIN_MODEL_NAME   "har_github"

/******************************************************************************/
#define AI_NETWORK_1669802707750_ACTIVATIONS_ALIGNMENT   (4)
#define AI_NETWORK_1669802707750_INPUTS_IN_ACTIVATIONS   (4)
#define AI_NETWORK_1669802707750_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_NETWORK_1669802707750_IN_NUM        (1)

AI_DEPRECATED
#define AI_NETWORK_1669802707750_IN \
  ai_network_1669802707750_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_1669802707750_IN_SIZE { \
  AI_NETWORK_1669802707750_IN_1_SIZE, \
}
#define AI_NETWORK_1669802707750_IN_SIZE_BYTES { \
  AI_NETWORK_1669802707750_IN_1_SIZE_BYTES, \
}
#define AI_NETWORK_1669802707750_IN_1_HEIGHT      (90)
#define AI_NETWORK_1669802707750_IN_1_WIDTH       (3)
#define AI_NETWORK_1669802707750_IN_1_CHANNEL     (1)
#define AI_NETWORK_1669802707750_IN_1_SIZE        (90 * 3 * 1)
#define AI_NETWORK_1669802707750_IN_1_SIZE_BYTES  (1080)

/******************************************************************************/
#define AI_NETWORK_1669802707750_OUT_NUM       (1)

AI_DEPRECATED
#define AI_NETWORK_1669802707750_OUT \
  ai_network_1669802707750_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_1669802707750_OUT_SIZE { \
  AI_NETWORK_1669802707750_OUT_1_SIZE, \
}
#define AI_NETWORK_1669802707750_OUT_SIZE_BYTES { \
  AI_NETWORK_1669802707750_OUT_1_SIZE_BYTES, \
}
#define AI_NETWORK_1669802707750_OUT_1_CHANNEL     (6)
#define AI_NETWORK_1669802707750_OUT_1_SIZE        (6)
#define AI_NETWORK_1669802707750_OUT_1_SIZE_BYTES  (24)

/******************************************************************************/
#define AI_NETWORK_1669802707750_N_NODES (7)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup network_1669802707750
...
AI_DEPRECATED
AI_API_ENTRY
ai_bool ai_network_1669802707750_get_info(
 ...
 * @ref ai_network_1669802707750_create. Both the activations memory buffer 
 ...
 * using @ref ai_network_1669802707750_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_error ai_network_1669802707750_create_and_init(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_1669802707750_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_1669802707750_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_NETWORK_1669802707750_*
 * defines into file @ref network_1669802707750.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_network_1669802707750_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_NETWORK_1669802707750_H */
