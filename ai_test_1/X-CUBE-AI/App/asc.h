...
#define AI_ASC_ORIGIN_MODEL_NAME   "session_keras_mod_93_model"

/******************************************************************************/
#define AI_ASC_ACTIVATIONS_ALIGNMENT   (4)
#define AI_ASC_INPUTS_IN_ACTIVATIONS   (4)
#define AI_ASC_OUTPUTS_IN_ACTIVATIONS  (4)
...
AI_DEPRECATED
#define AI_ASC_IN \
  ai_asc_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_ASC_IN_SIZE { \
  AI_ASC_IN_1_SIZE, \
}
#define AI_ASC_IN_SIZE_BYTES { \
  AI_ASC_IN_1_SIZE_BYTES, \
}
#define AI_ASC_IN_1_HEIGHT      (30)
#define AI_ASC_IN_1_WIDTH       (32)
#define AI_ASC_IN_1_CHANNEL     (1)
#define AI_ASC_IN_1_SIZE        (30 * 32 * 1)
#define AI_ASC_IN_1_SIZE_BYTES  (3840)
...
AI_DEPRECATED
#define AI_ASC_OUT \
  ai_asc_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_ASC_OUT_SIZE { \
  AI_ASC_OUT_1_SIZE, \
}
#define AI_ASC_OUT_SIZE_BYTES { \
  AI_ASC_OUT_1_SIZE_BYTES, \
}
#define AI_ASC_OUT_1_CHANNEL     (3)
#define AI_ASC_OUT_1_SIZE        (3)
#define AI_ASC_OUT_1_SIZE_BYTES  (12)

/******************************************************************************/
#define AI_ASC_N_NODES (6)
