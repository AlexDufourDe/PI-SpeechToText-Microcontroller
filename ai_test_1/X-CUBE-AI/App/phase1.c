...
#define AI_NET_OBJ_INSTANCE g_phase1
 
#undef AI_PHASE1_MODEL_SIGNATURE
#define AI_PHASE1_MODEL_SIGNATURE     "38233d661de28190ac223478d283e67e"
...
#define AI_TOOLS_DATE_TIME   "Thu Dec  1 15:58:31 2022"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_PHASE1_N_BATCHES
#define AI_PHASE1_N_BATCHES         (1)

static ai_ptr g_phase1_activations_map[1] = AI_C_ARRAY_INIT;
static ai_ptr g_phase1_weights_map[1] = AI_C_ARRAY_INIT;
...
/* Array#10 */
AI_ARRAY_OBJ_DECLARE(
  dense_19_weights_array, AI_ARRAY_FORMAT_LUT4_FLOAT,
...
AI_TENSOR_OBJ_DECLARE(
  ...
  10, 0x0,
  AI_SHAPE_INIT(4, 4096, 256, 1, 1), AI_STRIDE_INIT(4, 1, 2048, 524288, 524288),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 909928, 1, 1),
    909928, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 278144, 1, 1),
    278144, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_PHASE1_IN_NUM, &serving_default_conv2d_3_input0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_PHASE1_OUT_NUM, &nl_21_output),
...
/******************************************************************************/
AI_DECLARE_STATIC
ai_bool phase1_configure_activations(
  ai_network* net_ctx, const ai_network_params* params)
{
  AI_ASSERT(net_ctx)

  if (ai_platform_get_activations_map(g_phase1_activations_map, 1, params)) {
    /* Updating activations (byte) offsets */
    
    serving_default_conv2d_3_input0_output_array.data = AI_PTR(g_phase1_activations_map[0] + 245888);
    serving_default_conv2d_3_input0_output_array.data_start = AI_PTR(g_phase1_activations_map[0] + 245888);
    
    conv2d_0_output_array.data = AI_PTR(g_phase1_activations_map[0] + 0);
    conv2d_0_output_array.data_start = AI_PTR(g_phase1_activations_map[0] + 0);
    
    eltwise_2_output_array.data = AI_PTR(g_phase1_activations_map[0] + 0);
    eltwise_2_output_array.data_start = AI_PTR(g_phase1_activations_map[0] + 0);
    
    pool_3_output_array.data = AI_PTR(g_phase1_activations_map[0] + 0);
    pool_3_output_array.data_start = AI_PTR(g_phase1_activations_map[0] + 0);
    
    eltwise_5_output_array.data = AI_PTR(g_phase1_activations_map[0] + 65536);
    eltwise_5_output_array.data_start = AI_PTR(g_phase1_activations_map[0] + 65536);
    
    conv2d_6_output_array.data = AI_PTR(g_phase1_activations_map[0] + 131072);
    conv2d_6_output_array.data_start = AI_PTR(g_phase1_activations_map[0] + 131072);
    
    eltwise_8_output_array.data = AI_PTR(g_phase1_activations_map[0] + 0);
    eltwise_8_output_array.data_start = AI_PTR(g_phase1_activations_map[0] + 0);
    
    pool_9_output_array.data = AI_PTR(g_phase1_activations_map[0] + 131072);
    pool_9_output_array.data_start = AI_PTR(g_phase1_activations_map[0] + 131072);
    
    eltwise_11_output_array.data = AI_PTR(g_phase1_activations_map[0] + 0);
    eltwise_11_output_array.data_start = AI_PTR(g_phase1_activations_map[0] + 0);
    
    conv2d_12_output_array.data = AI_PTR(g_phase1_activations_map[0] + 32768);
    conv2d_12_output_array.data_start = AI_PTR(g_phase1_activations_map[0] + 32768);
    
    eltwise_14_output_array.data = AI_PTR(g_phase1_activations_map[0] + 98304);
    eltwise_14_output_array.data_start = AI_PTR(g_phase1_activations_map[0] + 98304);
    
    pool_15_output_array.data = AI_PTR(g_phase1_activations_map[0] + 0);
    pool_15_output_array.data_start = AI_PTR(g_phase1_activations_map[0] + 0);
    
    eltwise_17_output_array.data = AI_PTR(g_phase1_activations_map[0] + 16384);
    eltwise_17_output_array.data_start = AI_PTR(g_phase1_activations_map[0] + 16384);
    
    dense_19_output_array.data = AI_PTR(g_phase1_activations_map[0] + 0);
    dense_19_output_array.data_start = AI_PTR(g_phase1_activations_map[0] + 0);
    
    nl_19_nl_output_array.data = AI_PTR(g_phase1_activations_map[0] + 1024);
    nl_19_nl_output_array.data_start = AI_PTR(g_phase1_activations_map[0] + 1024);
    
    dense_20_output_array.data = AI_PTR(g_phase1_activations_map[0] + 0);
    dense_20_output_array.data_start = AI_PTR(g_phase1_activations_map[0] + 0);
    
    nl_21_output_array.data = AI_PTR(g_phase1_activations_map[0] + 40);
    nl_21_output_array.data_start = AI_PTR(g_phase1_activations_map[0] + 40);
...
/******************************************************************************/
AI_DECLARE_STATIC
ai_bool phase1_configure_weights(
  ai_network* net_ctx, const ai_network_params* params)
{
  AI_ASSERT(net_ctx)

  if (ai_platform_get_weights_map(g_phase1_weights_map, 1, params)) {
    /* Updating weights (byte) offsets */
    
    eltwise_8_scale_array.format |= AI_FMT_FLAG_CONST;
    eltwise_8_scale_array.data = AI_PTR(g_phase1_weights_map[0] + 0);
    eltwise_8_scale_array.data_start = AI_PTR(g_phase1_weights_map[0] + 0);
    
    eltwise_8_bias_array.format |= AI_FMT_FLAG_CONST;
    eltwise_8_bias_array.data = AI_PTR(g_phase1_weights_map[0] + 256);
    eltwise_8_bias_array.data_start = AI_PTR(g_phase1_weights_map[0] + 256);
    
    eltwise_11_scale_array.format |= AI_FMT_FLAG_CONST;
    eltwise_11_scale_array.data = AI_PTR(g_phase1_weights_map[0] + 512);
    eltwise_11_scale_array.data_start = AI_PTR(g_phase1_weights_map[0] + 512);
    
    eltwise_11_bias_array.format |= AI_FMT_FLAG_CONST;
    eltwise_11_bias_array.data = AI_PTR(g_phase1_weights_map[0] + 768);
    eltwise_11_bias_array.data_start = AI_PTR(g_phase1_weights_map[0] + 768);
    
    conv2d_12_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_12_weights_array.data = AI_PTR(g_phase1_weights_map[0] + 1024);
    conv2d_12_weights_array.data_start = AI_PTR(g_phase1_weights_map[0] + 1024);
    
    conv2d_12_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_12_bias_array.data = AI_PTR(g_phase1_weights_map[0] + 295936);
    conv2d_12_bias_array.data_start = AI_PTR(g_phase1_weights_map[0] + 295936);
    
    eltwise_14_scale_array.format |= AI_FMT_FLAG_CONST;
    eltwise_14_scale_array.data = AI_PTR(g_phase1_weights_map[0] + 296448);
    eltwise_14_scale_array.data_start = AI_PTR(g_phase1_weights_map[0] + 296448);
    
    eltwise_14_bias_array.format |= AI_FMT_FLAG_CONST;
    eltwise_14_bias_array.data = AI_PTR(g_phase1_weights_map[0] + 296960);
    eltwise_14_bias_array.data_start = AI_PTR(g_phase1_weights_map[0] + 296960);
    
    eltwise_17_scale_array.format |= AI_FMT_FLAG_CONST;
    eltwise_17_scale_array.data = AI_PTR(g_phase1_weights_map[0] + 297472);
    eltwise_17_scale_array.data_start = AI_PTR(g_phase1_weights_map[0] + 297472);
    
    eltwise_17_bias_array.format |= AI_FMT_FLAG_CONST;
    eltwise_17_bias_array.data = AI_PTR(g_phase1_weights_map[0] + 297984);
    eltwise_17_bias_array.data_start = AI_PTR(g_phase1_weights_map[0] + 297984);
    
    dense_19_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_19_weights_array.data = AI_PTR(g_phase1_weights_map[0] + 298560);
    dense_19_weights_array.data_start = AI_PTR(g_phase1_weights_map[0] + 298496);
    
    dense_19_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_19_bias_array.data = AI_PTR(g_phase1_weights_map[0] + 822848);
    dense_19_bias_array.data_start = AI_PTR(g_phase1_weights_map[0] + 822848);
    
    dense_20_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_20_weights_array.data = AI_PTR(g_phase1_weights_map[0] + 823872);
    dense_20_weights_array.data_start = AI_PTR(g_phase1_weights_map[0] + 823872);
    
    dense_20_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_20_bias_array.data = AI_PTR(g_phase1_weights_map[0] + 834112);
    dense_20_bias_array.data_start = AI_PTR(g_phase1_weights_map[0] + 834112);
    
    conv2d_0_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_0_weights_array.data = AI_PTR(g_phase1_weights_map[0] + 834152);
    conv2d_0_weights_array.data_start = AI_PTR(g_phase1_weights_map[0] + 834152);
    
    conv2d_0_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_0_bias_array.data = AI_PTR(g_phase1_weights_map[0] + 835304);
    conv2d_0_bias_array.data_start = AI_PTR(g_phase1_weights_map[0] + 835304);
    
    eltwise_2_scale_array.format |= AI_FMT_FLAG_CONST;
    eltwise_2_scale_array.data = AI_PTR(g_phase1_weights_map[0] + 835432);
    eltwise_2_scale_array.data_start = AI_PTR(g_phase1_weights_map[0] + 835432);
    
    eltwise_2_bias_array.format |= AI_FMT_FLAG_CONST;
    eltwise_2_bias_array.data = AI_PTR(g_phase1_weights_map[0] + 835560);
    eltwise_2_bias_array.data_start = AI_PTR(g_phase1_weights_map[0] + 835560);
    
    eltwise_5_scale_array.format |= AI_FMT_FLAG_CONST;
    eltwise_5_scale_array.data = AI_PTR(g_phase1_weights_map[0] + 835688);
    eltwise_5_scale_array.data_start = AI_PTR(g_phase1_weights_map[0] + 835688);
    
    eltwise_5_bias_array.format |= AI_FMT_FLAG_CONST;
    eltwise_5_bias_array.data = AI_PTR(g_phase1_weights_map[0] + 835816);
    eltwise_5_bias_array.data_start = AI_PTR(g_phase1_weights_map[0] + 835816);
    
    conv2d_6_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_6_weights_array.data = AI_PTR(g_phase1_weights_map[0] + 835944);
    conv2d_6_weights_array.data_start = AI_PTR(g_phase1_weights_map[0] + 835944);
    
    conv2d_6_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_6_bias_array.data = AI_PTR(g_phase1_weights_map[0] + 909672);
    conv2d_6_bias_array.data_start = AI_PTR(g_phase1_weights_map[0] + 909672);
  ...
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_PHASE1_MODEL_NAME,
      .model_signature   = AI_PHASE1_MODEL_SIGNATURE,
...
AI_API_ENTRY
ai_error ai_phase1_get_error(ai_handle network)
{
  return ai_platform_network_get_error(network);
}

AI_API_ENTRY
ai_error ai_phase1_create(
...
AI_API_ENTRY
ai_error ai_phase1_create_and_init(
  ai_handle* network, const ai_handle activations[], const ai_handle weights[])
{
    ai_error err;
    ai_network_params params;

    err = ai_phase1_create(network, AI_PHASE1_DATA_CONFIG);
    if (err.type != AI_ERROR_NONE)
        return err;
    if (ai_phase1_data_params_get(&params) != true) {
        err = ai_phase1_get_error(*network);
        return err;
    }
#if defined(AI_PHASE1_DATA_ACTIVATIONS_COUNT)
    if (activations) {
...
#endif
#if defined(AI_PHASE1_DATA_WEIGHTS_COUNT)
    if (weights) {
...
#endif
    if (ai_phase1_init(*network, &params) != true) {
        err = ai_phase1_get_error(*network);
    }
    return err;
}
...
AI_API_ENTRY
ai_buffer* ai_phase1_inputs_get(ai_handle network, ai_u16 *n_buffer)
{
...
AI_API_ENTRY
ai_buffer* ai_phase1_outputs_get(ai_handle network, ai_u16 *n_buffer)
{
  if (network == AI_HANDLE_NULL) {
    network = (ai_handle)&AI_NET_OBJ_INSTANCE;
    ((ai_network *)network)->magic = AI_MAGIC_CONTEXT_TOKEN;
...
AI_API_ENTRY
ai_handle ai_phase1_destroy(ai_handle network)
{
  return ai_platform_network_destroy(network);
}

AI_API_ENTRY
ai_bool ai_phase1_init(
  ai_handle network, const ai_network_params* params)
{
  ...
  ai_bool ok = true;
  ok &= phase1_configure_weights(net_ctx, params);
  ok &= phase1_configure_activations(net_ctx, params);
...
AI_API_ENTRY
ai_i32 ai_phase1_forward(ai_handle network, const ai_buffer* input)
{
