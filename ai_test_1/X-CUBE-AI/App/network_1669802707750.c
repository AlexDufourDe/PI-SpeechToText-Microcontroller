...
#include "network_1669802707750.h"
#include "network_1669802707750_data.h"
...
#define AI_NET_OBJ_INSTANCE g_network_1669802707750
 
#undef AI_NETWORK_1669802707750_MODEL_SIGNATURE
#define AI_NETWORK_1669802707750_MODEL_SIGNATURE     "3b8ce54c1a2845a57ad45ed40af9fbe7"
...
#define AI_TOOLS_DATE_TIME   "Wed Nov 30 11:37:04 2022"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_NETWORK_1669802707750_N_BATCHES
#define AI_NETWORK_1669802707750_N_BATCHES         (1)

static ai_ptr g_network_1669802707750_activations_map[1] = AI_C_ARRAY_INIT;
static ai_ptr g_network_1669802707750_weights_map[1] = AI_C_ARRAY_INIT;
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    ...
    25600, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_1669802707750_IN_NUM, &input_0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_1669802707750_OUT_NUM, &dense_3_output),
...
/******************************************************************************/
AI_DECLARE_STATIC
ai_bool network_1669802707750_configure_activations(
...
/******************************************************************************/
AI_DECLARE_STATIC
ai_bool network_1669802707750_configure_weights(
  ai_network* net_ctx, const ai_network_params* params)
{
  AI_ASSERT(net_ctx)
  ...
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_NETWORK_1669802707750_MODEL_NAME,
  ...
  ai_handle* network, const ai_handle activations[], const ai_handle weights[])
{
    ...
    err = ai_network_1669802707750_create(network, AI_NETWORK_1669802707750_DATA_CONFIG);
    if (err.type != AI_ERROR_NONE)
        return err;
    if (ai_network_1669802707750_data_params_get(&params) != true) {
        err = ai_network_1669802707750_get_error(*network);
        return err;
    }
#if defined(AI_NETWORK_1669802707750_DATA_ACTIVATIONS_COUNT)
    if (activations) {
...
#endif
#if defined(AI_NETWORK_1669802707750_DATA_WEIGHTS_COUNT)
    if (weights) {
...
#endif
    if (ai_network_1669802707750_init(*network, &params) != true) {
        err = ai_network_1669802707750_get_error(*network);
    }
    return err;
}
...
AI_API_ENTRY
ai_buffer* ai_network_1669802707750_inputs_get(ai_handle network, ai_u16 *n_buffer)
{
...
AI_API_ENTRY
ai_buffer* ai_network_1669802707750_outputs_get(ai_handle network, ai_u16 *n_buffer)
{
  if (network == AI_HANDLE_NULL) {
    network = (ai_handle)&AI_NET_OBJ_INSTANCE;
    ((ai_network *)network)->magic = AI_MAGIC_CONTEXT_TOKEN;
