...
#include "phase_1_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_PHASE_1_MODEL_NAME          "phase_1"
#define AI_PHASE_1_ORIGIN_MODEL_NAME   "phase1"

/******************************************************************************/
#define AI_PHASE_1_ACTIVATIONS_ALIGNMENT   (4)
#define AI_PHASE_1_INPUTS_IN_ACTIVATIONS   (4)
#define AI_PHASE_1_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_PHASE_1_IN_NUM        (1)

AI_DEPRECATED
#define AI_PHASE_1_IN \
  ai_phase_1_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_PHASE_1_IN_SIZE { \
  AI_PHASE_1_IN_1_SIZE, \
}
#define AI_PHASE_1_IN_SIZE_BYTES { \
  AI_PHASE_1_IN_1_SIZE_BYTES, \
}
#define AI_PHASE_1_IN_1_HEIGHT      (63)
#define AI_PHASE_1_IN_1_WIDTH       (128)
#define AI_PHASE_1_IN_1_CHANNEL     (1)
#define AI_PHASE_1_IN_1_SIZE        (63 * 128 * 1)
#define AI_PHASE_1_IN_1_SIZE_BYTES  (32256)

/******************************************************************************/
#define AI_PHASE_1_OUT_NUM       (1)

AI_DEPRECATED
#define AI_PHASE_1_OUT \
  ai_phase_1_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_PHASE_1_OUT_SIZE { \
  AI_PHASE_1_OUT_1_SIZE, \
}
#define AI_PHASE_1_OUT_SIZE_BYTES { \
  AI_PHASE_1_OUT_1_SIZE_BYTES, \
}
#define AI_PHASE_1_OUT_1_CHANNEL     (10)
#define AI_PHASE_1_OUT_1_SIZE        (10)
#define AI_PHASE_1_OUT_1_SIZE_BYTES  (40)

/******************************************************************************/
#define AI_PHASE_1_N_NODES (16)
 ...
 * @ref ai_phase_1_create. Both the activations memory buffer 
 ...
 * using @ref ai_phase_1_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_phase_1_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_phase_1_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_PHASE_1_*
 * defines into file @ref phase_1.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
